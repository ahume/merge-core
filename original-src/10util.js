...
// namespaced OBJECT with browsers as its properties, returns boolean
guardian.r2.browser = {
	isWebKit: navigator.userAgent.indexOf('AppleWebKit/') > -1
};

// checks the IE version based on conditional compilation and sets its browser property to true
var is_ie = jQ.browser.msie;
if (is_ie) {
    var ie_version = parseInt(jQ.browser.version);
    guardian.r2.browser['isIE' + ie_version] = true;
}
