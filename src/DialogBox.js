define(function() {
	...
	DialogBox.prototype.showDialogBox = function(dialogBox, dialogBoxWrapper, scrollable, nonVisibleDialog) {
		if (guardian.r2.browser.isIE6) {
			document.body.parentNode.style.overflow = 'hidden';
		}
		scrollable = scrollable ? scrollable : false;
		this.positionDialogBox(dialogBox, dialogBoxWrapper, scrollable, nonVisibleDialog);
	...
	DialogBox.prototype.hideDialogBox = function (dialogBoxWrapper) {
		if (guardian.r2.browser.isIE6) {
	...
	DialogBox.prototype.positionDialogBox = function (dialogBox, dialogBoxWrapper, scrollable, nonVisibleDialog) {
	...
	DialogBox.prototype.createCloseLink = function(dialogBox, dialogBoxWrapper) {
		function closeDialogBox() {
			dialogBox.style.display = 'none';
			dialogBoxWrapper.style.display = 'none';
			this.hideDialogBox(dialogBoxWrapper);
		}
